...
<body>
	...
	<div class="container">
	    ...
	    <form action="${contextPath}/events/eventView.do" method="post" enctype="multipart/form-data">
	        <div class="view_area">
	                ...
	                <c:if test="${not empty article.imageFileName}">
	                    ...
	                    <span class="img">
	                        ...
	                        <span style="display:block;">
	                            <img id="preview" src="${contextPath}/eventdownload.do?imageFileName=${article.imageFileName}&articleNo=${article.articleNo}">
	                        </span>
	                    </span>
	                </c:if>
	            </p>
